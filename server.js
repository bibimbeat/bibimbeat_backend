...
app.use(function (req, res, next) {
    ...
    res.header("Access-Control-Allow-Origin", "https://bibimbeat.azurewebsites.net");
...
app.listen(port, () => {
    console.log(`Example app listening at https://bibimbeat-backend.azurewebsites.net`)
})